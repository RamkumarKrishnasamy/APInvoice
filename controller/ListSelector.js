sap.ui.define([
	...
	return BaseObject.extend("industry.gov.au.fi.apinv.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias industry.gov.au.fi.apinv.model.ListSelector
		 */
		 ...
		 * @return {industry.gov.au.fi.apinv.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
